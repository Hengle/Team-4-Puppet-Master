Shader "Nature Shaders/Vegetation"
{
    Properties
    {
        ...
        // Interaction
        _InteractionDuration("Interaction Duration", Range(0, 5)) = 1
        _InteractionStrength("Interaction Strength", Range(0, 1)) = 1
        _InteractionPushDown("Interaction PushDown", Range(0,1)) = 0.5
    ...
    SubShader
    {
        ...
        #pragma surface NatureShaderSurface StandardCustom vertex:NatureShaderVertex addshadow fullforwardshadows nolightmap
        ...
        #define PROPERTY_EmissionMap
        #define PROPERTY_EmissionColor
